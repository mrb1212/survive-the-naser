...
/** @type {string} */
const CACHE_VERSION = '1782581459|1361413989';
/** @type {string} */
const CACHE_PREFIX = 'Survive The Nase-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'survice the naser.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["survice the naser.html","survice the naser.js","survice the naser.offline.html","survice the naser.icon.png","survice the naser.apple-touch-icon.png","survice the naser.audio.worklet.js","survice the naser.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["survice the naser.wasm","survice the naser.pck"];
